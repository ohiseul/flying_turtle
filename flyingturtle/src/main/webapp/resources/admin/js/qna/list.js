...
window.onload = function() {
	$('head').append('<link rel="stylesheet" type="text/css" href="/flyingturtle/resources/admin/css/qna/list.css">');
	$("#searchType").hide();
};
...
function searchList() {
	...
	window.location.href="/flyingturtle/admin/qna/list.do?pageNo=1&searchType="+searchType+"&keyword="+ keyword;
}
