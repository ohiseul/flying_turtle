						...
						<tbody id="listBox">
							<c:forEach var="list" items="${lists}">
								<tr data-url="" id="${list.videoNo}">
									...
									<td><a
										href='<c:url value="/user/video/detail.do?subjectNo=${list.subjectNo}&videoNo=${list.videoNo}"/>'>${list.title}</a></td>
									<td>${list.id}</td>
...
<script>
	function givesubno() {
		window.location.href = "/flyingturtle/user/video/write.do?subjectNo=${param.subjectNo}";
	}
