...
<nav id="tour-nav">
	<div class="menu-wrapper">
		...
		<div class="menu">
			<a href="<c:url value="/user/notice/list.do?index=1"/>"> 
			<div><i class="fas fa-bullhorn"></i> 공지사항</div>
			</a>
		</div>
		<div class="menu">
			<a href="<c:url value="/user/qna/list.do?index=2"/>"> 
				<div><i class="fas fa-question"></i> 묻고답하기</div>
			</a>
		</div>
		<div class="menu">
			<a href="<c:url value="/user/video/list.do?index=3"/>"> 
				<div><i class="fab fa-youtube"></i> 동영상</div>
			</a>
		</div>
		<div class="menu">
			<a href="<c:url value="/user/todo/list.do?index=4"/>"> 
				<div><i class="far fa-check-circle"></i> todo</div>
			</a>
		</div>
		<div class="menu">
			<a href="<c:url value="/user/dictionary/list.do?index=5"/>"> 
