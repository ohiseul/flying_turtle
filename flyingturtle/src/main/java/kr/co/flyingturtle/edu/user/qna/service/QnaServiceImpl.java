...
//			System.out.println("DB::: "+result.toString());
	...
	public Map<String, Object> detail(Qna qna) throws Exception {
		...
		// getFileGroupNo():"+qna.getFileGroupNo()+"::::"+mapper.selectFileByNo(qna.getFileGroupNo()));
		// System.out.println("fileGroupNo:"+fileGroupNo);
		// System.out.println("서비스임플
		// getQnaNo():"+qna.getQnaNo()+"::::"+mapper.selectListAsw(qna.getQnaNo()));
		// System.out.println("서비스임플
		// getQnaNo:"+qna.getQnaNo()+"::::"+mapper.selectQnaByNo(qna.getQnaNo()));
		// System.out.println("DB::: "+result.toString());
	}
